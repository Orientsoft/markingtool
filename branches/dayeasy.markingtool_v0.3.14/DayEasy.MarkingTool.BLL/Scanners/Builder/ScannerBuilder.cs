...
namespace DayEasy.MarkingTool.BLL.Scanners.Builder
{
    ...
    public abstract class ScannerBuilder
    {
        ...
        protected FileManager BatchFile;
        ...
        protected ScannerBuilder(string imagePath, PaperUsageInfo usage,string classId,FileManager fileManager)
        {
            _imagePath = imagePath;
            _imageName = Path.GetFileName(imagePath);
            BatchFile = fileManager;
            ClassId = classId;
            UsageInfo = usage;
