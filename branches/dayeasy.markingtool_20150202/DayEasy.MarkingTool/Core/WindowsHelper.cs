...
namespace DayEasy.MarkingTool.Core
{
    public class WindowsHelper : Helper
    {
        ...
        public static void SetMarkedSymbols(MarkingResult result, string paperName)
        {
            string basePath = Path.Combine(DeyiKeys.SavePath, paperName, DeyiKeys.CompressName);
