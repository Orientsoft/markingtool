...
namespace DayEasy.MarkingTool.Core
{
    ...
    public class CursorManager
    {
        ...
        public  CursorManager(SymbolType symbolType):
            this(ConvertOperate(symbolType))
        {
        }

        private static MarkingOperate ConvertOperate(SymbolType symbolType)
        {
        ...
        public SymbolType GetMarkingSymbolType()
        {
            switch (_markingOperate)
            {
                case MarkingOperate.Hook:
                    return SymbolType.Right;
                case MarkingOperate.Fork:
                    return SymbolType.Wrong;
                case MarkingOperate.HalfHook:
                    return SymbolType.HalfRight;
                default:
                    return SymbolType.Right;
            }
        }
